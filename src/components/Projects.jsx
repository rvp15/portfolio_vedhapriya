...
const Projects = () => {
  ...
  return (
    <div
      name="projects"
      className=' text-white bg-gradient-to-b from-black via-black to-gray-800 w-full md:h-screen object-contain'>
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full ">
          ...
          <div  className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0 ">
            {projects.map((item) => (
              ...
              rel="noreferrer" >  <button className="w-1/2 px-6 py-5 m-4 duration-200 hover:scale-105">
                  Source Code
                </button></a>
